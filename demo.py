...
def render(fps: int):
    ...
    try:
        while True:
            draw_rectangle("@", 117, 0, 0, canvas[0], canvas[1])
            draw_rectangle("g", 40, 0, canvas[1]-3, canvas[0], 7)
            draw_rectangle("h", 208, canvas[0]-23, canvas[1]-13, 21, 10)
            draw_rectangle("d", 9, canvas[0]-21, canvas[1]-9, 5, 6)
            draw_rectangle("w", 11, canvas[0]-14, canvas[1]-10, 10, 5)
            draw_rectangle("f", 208, canvas[0]-10, canvas[1]-10, 2, 5)
            draw_rectangle("f", 208, canvas[0]-14, canvas[1]-8, 10, 1)
            draw_rectangle("h", 11, canvas[0]-18, canvas[1]-7, 1, 2)
            draw_ellipse("s", 11, 16, 7, 10, 5)
            draw_ellipse("s", 11, 16, 7, 9, 5)
            draw_ellipse("s", 11, 16, 7, 8, 5)
            draw_rectangle("s", 11, 9, 3, 15, 9)
            draw_ellipse("l", 21, 20, canvas[1]-4, 15, 2)
            draw_rectangle("l", 21, 6, canvas[1]-5, 29, 3)
            ...
            draw_pixel("r", 9, canvas[0]-13, canvas[1]-17)
            sl(1/fps)
            canvas = list(gts())
            canvas[1] += -1
