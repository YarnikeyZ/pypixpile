...
def render(fps: int):
    ...
    try:
        while True:
            ...
            drawLine("r", 9, 0, canvas[0]-24, canvas[1]-13, canvas[0]-13, canvas[1]-19)
            drawLine("r", 9, 0, canvas[0]-13, canvas[1]-19, canvas[0]-2, canvas[1]-13)
            drawLine("r", 9, 0, canvas[0]-24, canvas[1]-13, canvas[0]-2, canvas[1]-13)
            drawLine("r", 9, 0, canvas[0]-23, canvas[1]-14, canvas[0]-3, canvas[1]-14)
            drawLine("r", 9, 0, canvas[0]-21, canvas[1]-15, canvas[0]-5, canvas[1]-15)
            drawLine("r", 9, 0, canvas[0]-19, canvas[1]-16, canvas[0]-7, canvas[1]-16)
            drawLine("r", 9, 0, canvas[0]-17, canvas[1]-17, canvas[0]-9, canvas[1]-17)
            drawPixel("r", 9, 0, canvas[0]-13, canvas[1]-18)
